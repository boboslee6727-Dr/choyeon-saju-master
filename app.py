...
<span class='sub-title' style='font-size: 18px; font-weight: 900; color: #111;'>2) 겉으로 드러난 성격 (사회적 페르소나 및 추진력)</span>
- 일주({ds}{db}), 십성, 십이운성을 바탕으로 사회생활에서 드러나는 성격을 일반인이 쉽게 이해하도록 풀어서 서술하십시오.
- 12신살 통변 시 반드시 '사회적 무대 및 환경적 사건(년지 기준 12신살)'과 '내면 심리 및 실전 행동 파동(일지 기준 12신살)'의 차이점을 명확히 구별하여 설명하십시오.

<span class='sub-title' style='font-size: 18px; font-weight: 900; color: #111;'>3) 감추어진 내 속마음 (무의식적 결핍과 내면 심리)</span>
- 지장간 인종법과 공망의 양가적 의미를 바탕으로 원국에 숨겨진 육친의 심리와 내면의 공허함을 위로하듯 서술하십시오.
</div>
